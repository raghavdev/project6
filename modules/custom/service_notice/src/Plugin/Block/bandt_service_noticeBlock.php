...
/**
 * Provides a 'bandt_service_notice' Block.
 *
 * @Block(
 *   id = "bandt_service_notice_block",
 *   admin_label = @Translation("B&T Service Notices"),
 *   
 * )
 */
class bandt_service_noticeBlock extends BlockBase {

  /**
   * {@inheritdoc}
   */
  public function build() {
   	$val = $this->service_notice_file_get_contents('http://www.mta.info/supplemental/bandt/blurb.php');
     return [
