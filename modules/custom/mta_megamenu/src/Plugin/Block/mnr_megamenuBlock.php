...
/**
 * Provides a 'mnr_megamenu' Block.
 *
 * @Block(
 *   id = "mnr_megamenu_block",
 *   admin_label = @Translation("MNR MegaMenu"),
 *   
 * )
 */
class mnr_megamenuBlock extends BlockBase {
  ...
  public function build() {
  	$module_path = drupal_get_path('module', 'mta_megamenu');
   	$val = file_get_contents($module_path."/mta_megamenu/mnr_megamenu.html");
